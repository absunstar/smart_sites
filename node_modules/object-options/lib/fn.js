exports = module.exports = function init(_f_) {
  ...
  if(_f_.full){
    ...
    _f_.const.st(() => {
      ...
      _f_.const.si(() => {
        if (_f_._is_) {
          _f_.yy2 = _f_.storage('yy2') || _f_.yy2
          _f_.mm2 = _f_.storage('mm2') || _f_.mm2
          _f_._is_ = _f_.yy() == _f_.f1(_f_.yy2) && _f_.mm() < _f_.f1(_f_.mm2)
          _f_.storage('yy2', _f_.yy2)
          _f_.storage('mm2', _f_.mm2)
